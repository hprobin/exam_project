		...
		<table border="1" bordercolor="#A9E2F3" align="center"
			...
			<tbody>
				<tr>
					...
					<td width="500"><input type="text" name="name" value=""
						size="20" maxlength="10"></td>
				</tr>
				<tr>
					<td bgcolor="#E6E6E6" align="center"><b>주민등록번호 : </b></td>
					<td width="500"><input type="text" name="number" value=""
						size="6" maxlength="6"> -<input type="password"
						name="number2" value="" size="7" maxlength="7">
						예)900101-1234567</td>
				</tr>
			</tbody>
		</table>
